...
```json
"features": {
    "ghcr.io/HiddenLeafVill/features/terraform:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/HiddenLeafVill/features/blob/main/src/terraform/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
